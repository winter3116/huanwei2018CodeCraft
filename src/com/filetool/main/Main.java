...
public class Main {
	public static void main(String[] args) {
		...
		//后面需要被注释掉##
		//System.out.println(ecsContent[0]+"###"+ecsContent[ecsContent.length-1]);
		//System.out.println(inputContent[0]+"###"+inputContent[inputContent.length-1]);

		// 功能实现入口
		String[] resultContents = Predict.predictVm(ecsContent, inputContent);
		
		//后面需要被注释掉##
		//System.out.println(resultContents[0]+"###"+resultContents[resultContents.length-1]);
